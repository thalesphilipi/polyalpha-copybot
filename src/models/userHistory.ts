...
const positionSchema = new Schema({
    ...
    sourceTrader: { type: String, required: false }, // Address of the trader who originated this position
});
...
const activitySchema = new Schema({
    ...
    mySoldSize: { type: Number, required: false }, // Tracks actual tokens we sold
    mySoldValue: { type: Number, required: false }, // Tracks actual USD value we received
});
