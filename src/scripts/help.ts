...
console.log(
    `  ${colors.green}npm run check-proxy${colors.reset}       Check your wallet balance and positions`
);
console.log(
    `  ${colors.green}npm run check-both${colors.reset}        Check both your wallet and EOA`
);
console.log(
...
console.log(
    `  ${colors.green}npm run check-stats${colors.reset}       View your trading statistics`
);
console.log(
    `  ${colors.green}npm run check-activity${colors.reset}    See recent trading activity`
);
console.log(
    `  ${colors.green}npm run check-pnl${colors.reset}         Check profit & loss discrepancies`
);
console.log('');

console.log(`${colors.yellow}${colors.bright}🎯 POSITION MANAGEMENT${colors.reset}\n`);
console.log(
    `  ${colors.green}npm run manual-sell${colors.reset}       Manually sell a specific position`
);
console.log(
    `  ${colors.green}npm run sell-large${colors.reset}        Sell large positions (bulk action)`
);
console.log(`  ${colors.green}npm run close-stale${colors.reset}       Close stale/old positions`);
console.log(
    `  ${colors.green}npm run close-resolved${colors.reset}    Close resolved market positions`
);
console.log(
    `  ${colors.green}npm run redeem-resolved${colors.reset}   Redeem resolved positions for USDC`
);
console.log('');

console.log(`${colors.yellow}${colors.bright}🔍 TRADER RESEARCH${colors.reset}\n`);
console.log(
    `  ${colors.green}npm run find-traders${colors.reset}      Find best performing traders`
);
console.log(`  ${colors.green}npm run find-low-risk${colors.reset}     Find low-risk traders`);
console.log(
    `  ${colors.green}npm run scan-traders${colors.reset}      Scan and analyze top traders`
);
console.log(
    `  ${colors.green}npm run scan-markets${colors.reset}      Scan traders from popular markets`
);
console.log('');

console.log(`${colors.yellow}${colors.bright}🧪 SIMULATION & TESTING${colors.reset}\n`);
console.log(
    `  ${colors.green}npm run simulate${colors.reset}          Simulate profitability with current logic`
);
console.log(
    `  ${colors.green}npm run simulate-old${colors.reset}      Simulate with old algorithm`
);
console.log(
    `  ${colors.green}npm run sim${colors.reset}               Run comprehensive simulations`
);
...
console.log(
    `  ${colors.green}npm run audit${colors.reset}             Audit copy trading algorithm`
);
console.log(
    `  ${colors.green}npm run fetch-history${colors.reset}     Fetch historical trade data`
);
